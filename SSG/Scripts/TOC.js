...
function GetCurrentUrl()
{
    ...
    try
    {
        url = parent.TopicContent.document.URL.replace(/\\/g, "/");
    }
    catch(e)
    {
    ...
    for(divIdx = 0; divIdx < divs.length; divIdx++)
          ...
          divs[divIdx].className == "Visible")
        {
            ...
            if(div.className == "Visible" && !expandNodes)
            {
                ...
                img.src = "Icons/Collapsed.gif";
            }
            else
                if(div.className == "Hidden" && expandNodes)
                {
                    div.className = "Visible";
                    img.src = "Icons/Expanded.gif";
...
function Toggle(node)
{
    ...
    {
        div.className = "Hidden";
        node.src = "Icons/Collapsed.gif";
    }
    else
    {
        div.className = "Visible";
        node.src = "Icons/Expanded.gif";
